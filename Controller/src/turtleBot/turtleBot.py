...
class TurtleBot:
    ...
    def _rotate(self, angle: float):
        ...
        while self.robot.step(self.timeStep) != -1:
            ...
            currentRotation = (rightRotationChange - leftRotationChange) * self.radius / self.distanceBetweenWheels
    ...
    def movePosition(self, x: float, y: float, angle: float):
        ...
        target_angle = self.position[2] + math.radians(angle) if angle is not None else self.position[2]
